...
public class SpeakerDetailsView extends SpeakerDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.xebia.conference.view.gwt.client.managed.ui.SpeakerDetailsView instance;
    ...
    public static org.xebia.conference.view.gwt.client.managed.ui.SpeakerDetailsView instance() {
        if (instance == null) {
            instance = new SpeakerDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, SpeakerDetailsView> {
    }
}
