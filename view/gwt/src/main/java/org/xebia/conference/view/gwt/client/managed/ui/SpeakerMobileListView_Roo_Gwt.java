...
public abstract class SpeakerMobileListView_Roo_Gwt extends MobileProxyListView<SpeakerProxy> {

    protected Set<String> paths = new HashSet<String>();

    public SpeakerMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.xebia.conference.view.gwt.client.proxy.SpeakerProxy> renderer) {
