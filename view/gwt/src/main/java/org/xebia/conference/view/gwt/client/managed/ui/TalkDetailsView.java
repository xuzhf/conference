...
public class TalkDetailsView extends TalkDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.xebia.conference.view.gwt.client.managed.ui.TalkDetailsView instance;
    ...
    public static org.xebia.conference.view.gwt.client.managed.ui.TalkDetailsView instance() {
        if (instance == null) {
            instance = new TalkDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, TalkDetailsView> {
    }
}
