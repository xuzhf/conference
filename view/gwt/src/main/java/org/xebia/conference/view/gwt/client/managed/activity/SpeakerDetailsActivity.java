...
public class SpeakerDetailsActivity extends SpeakerDetailsActivity_Roo_Gwt {

    public SpeakerDetailsActivity(EntityProxyId<org.xebia.conference.view.gwt.client.proxy.SpeakerProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<org.xebia.conference.view.gwt.client.proxy.SpeakerProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(SpeakerProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((SpeakerProxy) proxy);
